...
// Data for recommended papers
const dataRecomendasiPaper = [
    {
        category: 'Free',
        listPaper: [
            { title: 'Kesatria', link: 'https://tunasbangsa.ac.id/pkm/index.php/kesatria/pages/view/authorfees' },
            { title: 'Sistemasi', link: 'https://sistemasi.ftik.unisi.ac.id/index.php/stmsi' },
            { title: 'Jurnal Sisfokom', link: 'https://jurnal.atmaluhur.ac.id/index.php/sisfokom/' },
            { title: 'JMSK', link: 'https://journal.unhas.ac.id/index.php/jmsk/about' }
        ]
    },
    {
        category: 'Regular',
        listPaper: [
            { title: 'Komputasi', link: 'https://ejournal.jak-stik.ac.id/index.php/komputasi' },
            { title: 'Brillant', link: 'https://jurnal.unublitar.ac.id/index.php/briliant' },
            { title: 'Explore', link: 'https://jurnal.ubl.ac.id/' },
            { title: 'MIB', link: 'https://ejurnal.stmik-budidarma.ac.id/index.php/mib' }
        ]
    },
    {
        category: 'Fast Track',
        listPaper: [
            { title: 'JSINBIS', link: 'https://ejournal.undip.ac.id/index.php/jsinbis' },
            { title: 'G-Tech', link: 'https://ejournal.uniramalang.ac.id/index.php/g-tech/index' },
            { title: 'J-ICOM', link: 'http://ejurnalunsam.id/index.php/jicom' },
            { title: 'JIPI', link: 'https://jurnal.stkippgritulungagung.ac.id/index.php/jipi/index' }
        ]
    }
];
...
interface TitledescriptionProps {
    title: string;
    description: string;
    listPaper: { title: string, link: string }[];
}

// Container for each category (Free, Regular, Fast Track)
...
// List item component for each paper
interface ListProps {
    title: string;
    link: string;
}
