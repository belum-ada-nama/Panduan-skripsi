    ...
    <div>
      <div className="text-center py-20 px-6 space-y-6 lg:w-[1051px] mx-auto">
        <SectionTitle
          ...
          description="Template ini membantu menyusun komunikasi yang jelas dan efektif dengan dosen."
        />
        <div className="p-4 rounded-lg space-y-4">
          {/* Pesan Pengirim */}
          <div className="flex justify-end relative">
            <div className="max-w-[90%] lg:max-w-[70%] bg-[#D9FDD3] text-black p-3 rounded-lg relative text-start">
            ...
            <div className="cursor-pointer">
              <button
                className="mt-2 p-6 absolute -bottom-14 -right-4 text-white rounded-lg  flex items-center justify-center"
          ...
          <div className="flex justify-start relative">
            <div className="max-w-[90%] lg:max-w-[70%] bg-white text-black p-3 rounded-lg relative">
              <p className="text-start">baik, noted</p>
            </div>
          </div>
        </div>
      </div>
